...
@WebServlet("/congeAttente")
public class CongeEnAttenteServlet extends AbstractGenericServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        templateEngine.process("DemandeAttenteVA", context, resp.getWriter());
    }
}
